...
\label{ch:safety}
    ...
    \section{Risk Management}
      ...
      \section{General Emergency Procedures}\label{sec:ep-general}
            ...
            \subsubsection{Pilot Priorities} Loss of control of the aircraft remains the highest risk related to \claudereplace{sUAS}{\ac{suas}} operations. The following priorities should be followed by operators during an in-flight emergency:
...
Crew members must quickly recognize such abnormal behavior, check if the autopilot still responds to override commands, and be prepared to switch to manual control or trigger flight termination if the aircraft cannot be contained within the safe area.
            ...
            \subsubsection{Immediate Actions (All Flights)}
                ...
                \paragraph{} Communicate the emergency to all \claudereplace{crew members}{crewmembers} and, if applicable, to air traffic control or range control, especially if the \ac{uas} is leaving the intended operating area.
        ...
        \subsection{Ground Risk Incursion}\label{ssec:ep-groundrisk}
            ...
            \begin{itemize}
                \item Visual observation by the \ac{rpic}, \ac{vo}, or other \claudereplace{crew members}{crewmembers} of a person, vehicle, or animal entering the restricted operating area.
                \item Alerts or calls from support personnel (e.g., a team member positioned near a \claudereplace{landing zone}{\ac{lz}}) indicating that an unauthorized entry has occurred.
            ...
            \end{itemize}
            Once a ground incursion is noticed, the \ac{rpic} (or any \claudereplace{crew member}{crewmember}) should immediately assess the position and movement of the intruder relative to the \ac{uas}. Key considerations include whether the \ac{uas} is on approach to that area, how much time is available to react, and what evasive action will best protect both the person and the aircraft.
            ...
            \subsubsection{Immediate Actions (All Flights)}
                \paragraph{} If the \ac{uas} is on final approach to land and a person or obstacle is spotted in the \claudereplace{landing zone}{\ac{lz}}, immediately execute a go-around or climb to a hover at a safe altitude. The landing should be aborted without hesitation.
                ...
                \paragraph{} If \claudereplace{crew members}{crewmembers} are available, have one attempt to warn or guide the intruder away from the danger (shout, wave, or approach if it can be done safely) while the \ac{rpic} keeps the \ac{uas} clear.
                \paragraph{} Consider utilizing an alternate \claudereplace{landing zone}{\ac{lz}} if one has been designated and it is known to be clear. This can shorten the time the \ac{uas} must remain airborne with low battery or other constraints.
        ...
        \subsection{Unsafe Weather / Knock-it-Off}\label{ssec:ep-weather}
            ...
            \begin{itemize}
                ...
                \item Any \claudereplace{crew member's}{crewmember's} judgment that conditions have become unsafe (this could include non-weather factors, such as another concurrent safety issue—when in doubt, they call "Knock it Off").
            \end{itemize}
            ...
            \subsubsection{Priorities} In an unsafe weather or “Knock-it-Off” situation:
                \paragraph{}Preserve life and safety: ensure \claudereplace{crew members}{crewmembers} and bystanders are not put at risk by the operation (for example, cease flight before a lightning storm arrives, so no one has to handle electronics outside during lightning).
        ...
        \subsection{Low Battery Emergency Landing}\label{ssec:ep-lowbattery}
            ...
            \subsubsection{Immediate Actions (All Flights)}
                ...
                \paragraph{} Acknowledge the low battery alert and immediately terminate the mission segment. Command an immediate \claudereplace{return-to-home}{\ac{rth}} or navigate to the nearest safe landing site without delay.
