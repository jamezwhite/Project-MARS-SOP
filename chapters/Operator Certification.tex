...
\label{ch:certification}
    ...
    \section{Requirements for All Aircrew Personnel}\label{sec:qual-reqsall}
            ...
            \subsubsection{} The following personnel may fly and/or operate \projectmars{} airframes.  Personnel who --

                    \paragraph{} Are members of the Regular Army, \ac{usar}, \ac{arng}, or Civilian employees of the U.S. Army or \ac{dha}.

                    \paragraph{} Have complied with the qualification, training, evaluation, and currency requirements of this \ac{sop} for the airframe to be flown and/or operated.
    ...
    \section{Qualified Pilot Qualification}\label{sec:qual-qp} 
            ...
            \subsubsection{Requirements}\acf{qp} level is the intermediate level of qualification for \projectmars{}. In addition to the requirements of \claudereplace{nameref{sec:qual-ao}}{Cref{sec:qual-ao}}, \ac{qp} qualification requires graduation from the \ac{suas} Operator Course.
    ...
    \section{Expert Operator Qualification}\label{sec:qual-eo}
            ...
            \subsubsection{Requirements}\acf{eo} qualification is the highest level of qualification recognized by \projectmars{}.  In addition to the requirements for \claudereplace{nameref{sec:qual-qp}}{Cref{sec:qual-qp}}, \ac{eo} qualification requires Appointment Orders signed by the \nameref{role:projectoic}.  While not a qualification requirement, attendance of the \ac{suas} Master Trainer Course is strongly encouraged for \ac{eo}, and they will be prioritized for attendance. 
