\chapter{\texorpdfstring{Aircrew Certification, Training \& Currency}{Aircrew Certification, Training, and Currency}}
\label{ch:certification}
    ...
    \section{Requirements for All Aircrew Personnel}\label{sec:qual-reqsall}
    
        The following personnel may fly and/or operate \projectmars{} airframes.  Personnel who --

            \subsubsection{} Are members of the Regular Army, \ac{usar}, \ac{arng}, or Civilian employees of the U.S. Army or \ac{dha}.

            \subsubsection{} Have complied with the qualification, training, evaluation, and currency requirements of this \ac{sop} for the airframe to be flown and/or operated.

            \subsubsection{} Meet the medical standard as outlined in AR 40-501 (but are not required to maintain a class IV physical).

    \section{Autonomous Operator Qualification}\label{sec:qual-ao}
    ...
    \section{Qualified Pilot Qualification}\label{sec:qual-qp} 
    ...
    \section{Currency and Recurrency Requirements}\label{sec:currencyreqs}
            ...
            Currency requirements for \projectmars{} operators are dependent on the operator's level of qualification. 

                \subsubsection{Frequency} To be considered current, a \projectmars{} \ac{suas} operator must:
                ...
                \subsubsection{Tracking} Tracking actual flight time for a flying hour requirement is impractical and not required. Individual flight records folders are not required; however, documentation of flight operations (sorites) for the purpose of tracking currency is required. A qualified sortie is a launch, recovery, and autonomous flight for \ac{ao} currency, and a launch, recovery, and piloted flight for \ac{qp} or \ac{eo} currency.

                \subsubsection{Currency Lapse} \projectmars{} operators whose currency has lapsed must complete a proficiency flight evaluation by the \nameref{role:leadoperator} before conducting operations. Simulators may not be used to reestablish currency.

                \subsubsection{Waivers} Waivers to currency may only be granted by the \nameref{role:projectoic}.

                \subsubsection{Similar \ac{uas}}  Currency in one \projectmars{} \ac{suas} will satisfy requirement for all \ac{suas} belonging to the \projectmars{}.  Autonomous flights do not satisfy requirement for piloted flights. 
