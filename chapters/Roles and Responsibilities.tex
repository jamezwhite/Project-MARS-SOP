...
The Roles and Responsibilities of personnel involved in both the performance and oversight of \projectmars{} operations are defined in this chapter.
    ...
    \section{Permanent / Appointed Positions} The positions listed below are permanent/appointed positions. Appointment to positions specific to this Project will be accomplished by \ac{mfr} signed by the specified authority.
        ...
        \subsection{Hospital Commander}\label{role:hospitalcommander}
            ...
            \subsubsection{Responsibilities} The Hospital Commander's duties include, but are not limited to:
            \begin{itemize}
                \item Approving the establishment and continuation of the \projectmars{} program.
                \item Reviewing and approving risk acceptance for flight operations at the appropriate level.
                \item Appointing key personnel, including the \projectmars{} \ac{oic} and \ac{ncoic}, via MFR.
                \item Ensuring adequate resources, personnel, and oversight are available to safely conduct operations.
            \end{itemize}
        ...
        \subsection{Project MARS NCOIC}\label{role:projectncoic}
            ...
            \subsubsection{Primary Role} The Project MARS NCOIC is the senior enlisted leader responsible for the day-to-day execution, coordination, and enforcement of standards for \projectmars{} operations. The \ac{ncoic} ensures operational readiness and discipline across all personnel and missions.

            \subsubsection{Additional Responsibilities} The \ac{ncoic}'s duties include, but are not limited to:
            \begin{itemize}
                \item Coordinating and scheduling flight operations and personnel assignments.
                \item Verifying mission authorization prior to flight operations.
                \item Ensuring compliance with this SOP and all applicable regulations.
                \item Supervising enlisted personnel and crewmembers involved in operations.
                \item Maintaining accountability of equipment and operational status of the system.
                \item Serving as the primary point of contact for operational execution between the \ac{oic}, operators, and support personnel.
            \end{itemize}
    ...
    \section{Situational Positions}  The following positions are not permanent positions and are assigned on a per-flight basis. 
        ...
        \subsection{Remote Pilot in Charge}\label{role:rpic}
        ...
        \subsection{Crewmember}\label{role:crewmember}
            ...
            \subsubsection{Primary Role} Crewmembers are assigned personnel who support the safe execution of \projectmars{} flight operations at launch and landing zones. Crewmembers assist the \ac{rpic} in maintaining situational awareness, handling payloads, and ensuring safe ground operations.

            \subsubsection{Responsibilities} Crewmember duties include, but are not limited to:
            \begin{itemize}
                \item Assisting with aircraft setup, launch, recovery, and securing procedures.
                \item Maintaining communication with the \ac{rpic} and other crewmembers throughout the operation.
                \item Preparing, handling, and receiving payloads in accordance with \Cref{sec:approvedcargo}.
                \item Monitoring the landing zone for hazards, personnel, and obstacles.
                \item Providing visual and situational updates to the \ac{rpic} as required.
                \item Executing emergency procedures as briefed.
            \end{itemize}
        ...
        \subsection{Visual Observer}\label{role:visualobserver}

            \subsubsection{Primary Role} The Visual Observer (\ac{vo}) is assigned to assist the \ac{rpic} in maintaining safe operation of the aircraft by providing unaided visual observation of the airspace and surrounding environment. The \ac{vo} enhances situational awareness and supports compliance with \ac{vlos} requirements when applicable.

            \subsubsection{Responsibilities} The \ac{vo}'s duties include, but are not limited to:
            \begin{itemize}
                \item Maintaining continuous visual contact with the aircraft when required, using unaided vision.
                \item Scanning the surrounding airspace for hazards, including other aircraft, obstacles, and environmental threats.
                \item Immediately communicating any observed hazards or conflicts to the \ac{rpic}.
                \item Assisting the \ac{rpic} in determining aircraft position, altitude, and orientation when needed.
                \item Monitoring the operational area for unauthorized personnel or unsafe conditions.
                \item Supporting safe launch and recovery operations by observing the launch/landing zone.
            \end{itemize}
            
            \subsubsection{Qualification} Visual Observers will, at a minimum, be briefed on mission procedures, airspace awareness, and emergency protocols prior to assignment. Additional qualification requirements may be established by the \projectmars{} \ac{oic} and are outlined in \Cref{ch:certification}.
