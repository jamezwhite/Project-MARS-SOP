...
The Roles and Responsibilities of personnel involved in both the performance and oversight of \projectmars{} operations are defined in this chapter.
    ...
    \section{Permanent / Appointed Positions} The positions listed below are permanent/appointed positions. Appointment to positions specific to this Project will be accomplished by \ac{mfr} signed by the specified authority.
        ...
        \subsection{Project MARS NCOIC}\label{role:projectncoic}
            ...
            \subsubsection{Additional Responsibilities}
        ...
        \subsection{Lead Operator}\label{role:leadoperator}
            ...
            \subsubsection{Primary Role} The Lead Operator is the \projectmars{} \ac{sme} when it comes to flight operations., and will be \ac{eo} qualified. The Lead operator helps the \nameref{role:projectoic} develop,implement, and manage the \ac{atp}. The Lead Operator will conduct \ac{iqt} and \claudereplace{nameref{sec:qual-ao}}{Cref{sec:qual-ao}}.  If \ac{suas} Master Trainer Qualified, the Lead Operator will conduct \claudereplace{nameref{sec:qual-qp}}{Cref{sec:qual-qp}}; if not master qualified, the Lead Operator will assist with training of \projectmars{} personnel selected for \ac{qp} training.
        ...
        \subsection{Remote Pilot in Charge}\label{role:rpic}
            ...
            \subsubsection{}A designated government employee is assigned as the \ac{rpic} for all flights. The \ac{rpic} is responsible for evaluating the situation and making timely decisions for the safe operation of the \projectmars{} aircraft at all times, even when the aircraft is following pre-programmed commands. The \ac{rpic} is the final authority as to the operation of the aircraft. The \ac{rpic}'s duties include, but are not limited to:
                ...
                \begin{itemize}
                    ...
                    \item Making verbal connection with the \nameref{role:crewmember}(s) on the arriving \ac{lz} and ensure they are staged and prepared to receive the aircraft BEFORE \claudereplace{liftoff}{takeoff}.
            ...
            \subsubsection{Qualification} Qualification requirements to serve as \ac{rpic} are laid out in \Cref{ch:certification}. At a minimum, personnel service as an \ac{rpic} for autonomous flights will be certified to \claudereplace{nameref{sec:qual-ao}}{Cref{sec:qual-ao}} standards. To serve as \ac{rpic} during manual flight modes, personnel will be certified to \claudereplace{nameref{sec:qual-qp}}{Cref{sec:qual-qp}} standards.
    
        \subsection{Crewmember}\label{role:crewmember}

            \subsubsection{}
            
            \subsubsection{Qualification} At a minimum, all assigned crewmembers will have an \ac{ao} qualification. Requirements for this qualification are laid out in \claudereplace{cref{ch:certification}}{Cref{ch:certification}}.
