...
\label{ch:safety}
    ...
    \section{Specific Emergency Procedures}
        ...
        \subsection{Lost Communication (Lost Link)}\label{ssec:ep-losslink}
            ...
            \subsubsection{Autonomous Flight Mode Specific Considerations} Loss of link during autonomous flight presents less risk than doing so during person-controlled flight, as the aircraft is already traveling on a pre-programmed route and does not need active input from the \ac{rpic}.  However, loss of link is not a normal condition and may reflect additional issues with the aircraft.  \ac{rpic}'s who are \ac{ao} qualified may not be equipped for the possible repercussions of this emergency and should immediately contact someone who is \namecref{sec:qual-qp} for assistance.
      
            \subsubsection{Controlled Flight Mode Specific Considerations}
            Loss of link during controlled flight represents a distinct emergency. An aircraft in a piloted flight mode that has lost link is a hazard to everyone that is within its potential flight range, as there is not a way to control it without reestablishing link.  \ac{rpic}'s who experience a lost link must stay calm, attempt to recover the link, and be prepared to intervene if the aircraft looks to be heading in an unsafe direction.
       
            \subsubsection{Reporting and Documentation}
            
                \paragraph{} Loss of Link is not, in itself, a reportable mishap. In the event of a loss of link, the \ac{rpic} will log the time, location, telemetry status, and any deviation from planned route on their flight log, and report it to the \namecref{role:projectncoic}.  
