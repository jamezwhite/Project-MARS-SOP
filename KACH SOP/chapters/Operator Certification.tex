...
\label{ch:certification}
    ...
    \section{\acf{eo} Qualification}\label{sec:qual-eo}
            ...
            \subsubsection{Role} As the highest trained operators within \projectmars{}, \ac{eo}s will act as \ac{sme}s for all \ac{suas} operations. They will act as flight instructors and operator evaluators for all \projectmars{} personnel. The \nameref{role:leadoperator} must be \ac{eo} qualified.
